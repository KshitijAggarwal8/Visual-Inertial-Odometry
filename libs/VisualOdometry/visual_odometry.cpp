...
std::vector<cv::DMatch> vo::VisualOdometry::compute_matches(
...
Eigen::Matrix4f vo::VisualOdometry::estimate_pose(
    std::vector<cv::DMatch> matches, Eigen::Matrix3f camera_intrinsics) {
  // Placeholder for the pose estimation

  return Eigen::Matrix4f::Identity();
}

Eigen::Matrix4f vo::VisualOdometry::track_motion(cv::Mat prev_frame,
                                                 cv::Mat curr_frame) {
