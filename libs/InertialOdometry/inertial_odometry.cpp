...
Eigen::MatrixXf io::InertialOdometry::preintegrate_IMU_data(const std::vector<Eigen::Vector3f>& imu_data, 
...
Eigen::Vector3f io::InertialOdometry::correct_bias(const Eigen::Vector3f& bias) {
    // Implementation of the bias correction logic
    Eigen::Vector3f corrected_bias = bias; // Placeholder
    return corrected_bias;
}

Eigen::Matrix4f io::InertialOdometry::estimate_motion(const Eigen::MatrixXf& preintegrated_data) {
